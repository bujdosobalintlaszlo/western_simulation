...
{
    public EmptyField(int xIndex, int yIndex, int zIndex, string type,bool walkable) : base(xIndex, yIndex, zIndex, type,walkable)
    {
    }
    void Awake()
    {
        SpriteRenderer renderer = gameObject.AddComponent<SpriteRenderer>();
        renderer.sprite = Resources.Load<Sprite>("Sprites/EmptyField");
    }
    public override void DisplayField()
    {
        ...
        Sprite sprite = Resources.Load<Sprite>("emptyField1");
